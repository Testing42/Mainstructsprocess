...
//interfaces can embedd other interfaces you have made
//or anyother methods
/*
this is an option to use both interfaces above but
the better option is to use an embedded interface above.
type outputtable interface {
	Save() error
	Display()
}
